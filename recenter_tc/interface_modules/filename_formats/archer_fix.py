...
def archer_fix(xarray_obj,
               extension=None, basedir=gpaths['ARCHER_FIX_PATH'],
               variable_name=None, archer_channel_type=None,
               use_storm_subdirs=False):
    area_def = xarray_obj.area_definition
    basin_letter = get_basin_letter(area_def.sector_info['storm_basin'],
...
def assemble_archer_fname(basedir, variable_name, archer_channel_type,
                          ...
                          platform_name, product_datetime, data_provider, basin_letter, extension='.txt',
                          use_storm_subdirs=False):
